...
export const ExplainModal: React.FC<ExplainModalProps> = ({ isOpen, onClose }) => {
  ...
  return (
    <div id="explain-modal" className="fixed inset-0 z-[100] bg-background/60 backdrop-blur-sm flex items-center justify-center p-6 animate-in fade-in duration-200">
